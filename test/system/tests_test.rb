...
class TestsTest < ApplicationSystemTestCase
  ...
  test "creating a Test" do
    ...
    fill_in "Double", with: @test.double
    fill_in "Quad", with: @test.quad
    fill_in "Single", with: @test.single
    fill_in "Testing", with: @test.testing
    fill_in "Triple", with: @test.triple
